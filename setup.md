...
GatorLink VPN is required to access University of Florida Research Computing OnDemand
...
Creating an account for the Nanopore community is required to access the protocols and software downloads such as MinKNOW, the operating software that drives nanopore sequencing devices. 
Community also provide the online training, and platform for discussion within the community.
...
1. Click on **Software Downloads** on the right panel.
...
[Note] Please **DO NOT** download MinION Mk1C software. It is a different sequencing device with touchscreen, which is not used in this workshop. 
<img src="fig/Community_MinION.png" align="center" width="700">
3. Click on **MinKNOW icon** on your desktop
4. You will need to log in before start sequencing
